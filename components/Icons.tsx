...
export const IconFingerprint = ({ className, style }: { className?: string; style?: React.CSSProperties }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
    ...
    <path d="M5 15a10 10 0 0 1 13.9-6.1" />
    <path d="M8 18a10 10 0 0 1 10.3-6.2" />
    <path d="M11 20a10 10 0 0 1 6.6-7" />
    <path d="M14 21a10 10 0 0 1 2.8-8" />
    <path d="M9 13v.01" />
    <path d="M12 11v.01" />
    <path d="M15 13v.01" />
  </svg>
...
export const IconUnlock = ({ className }: { className?: string }) => (
